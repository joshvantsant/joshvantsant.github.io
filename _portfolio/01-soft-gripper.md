...
## Soft Robotic Gripper in Space Applications
**BioMorphic Intelligence Lab, TU Delft · Research Assistant · Current**

*Tools: Fusion 360 · 3D Printing · SMA Actuation · Physical Testing*

As a research assistant at the [BioMorphic Intelligence Lab](https://www.tudelft.nl/ai/biomorphic-intelligence-lab), I am 
contributing to the design and development of a shape memory alloy (SMA) actuated soft robotic gripper for space applications. This work in collaboration with dr. Fernando Ruiz Vinceria
...
technique but incorporates micro-hooks into the 3D printed design to allow for both a confirmed but secure grip on a variety of space rocks. 


![Micro-hook gripper CAD](/images/soft-gripper-cad.jpg)

### Skills Developed
`Soft Robotics` · `Fusion 360` · `FDM 3D Printing` · `SMA Actuation` · 
`Iterative Prototyping` · `Physical Testing`
